#!/bin/sh
# Base16 Fruit - Console color setup script
# FruitieX

color00="1e/1e/1e" # Base 00 - Black
color01="ad/76/74" # Base 08 - Red
color02="8f/a0/6a" # Base 0B - Green
color03="c9/c9/a8" # Base 0A - Yellow
...
color15="dd/dd/dd" # Base 07 - Bright White
