...
FILES=( bin src .apvlvrc .compton.conf .config .colors .dir_colors .gconf .mozilla .synergy.conf .tmux.conf .tmux.servy .theme.cfg .urlview .vimrc .vim/autoload/pathogen.vim .xinitrc .Xdefaults .Xmodmap .zshrc .zprofile .zpreztorc )
