...
FILES=( _pentadactylrc bin .apvlvrc .compton.conf .config .colors .conkyrc .dir_colors .gconf .gitignore_global .synergy.conf .tmux.conf .tmux.servy .theme.cfg .urlview .nvimrc .xinitrc .Xdefaults .Xmodmap .zshrc .zprofile .zpreztorc .zprezto .weechat)
