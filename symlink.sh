...
FILES=( _pentadactylrc bin .apvlvrc .compton.conf .config .colors .conkyrc .dir_colors .gconf .gitignore_global .synergy.conf .tmux.conf .tmux-osx.conf .tmux.servy .theme.cfg .urlview .nvimrc .xinitrc .Xdefaults .Xmodmap .zshrc .zprofile .zpreztorc .zprezto .weechat .tern-config .ycm_extra_conf.py)
