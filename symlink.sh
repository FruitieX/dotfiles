...
FILES=( bin .apvlvrc .compton.conf .config .colors .oh-my-zsh .synergy.conf .tmux.conf .urlview .vimrc .vim/autoload/pathogen.vim .weechat .Xdefaults .xinitrc .Xmodmap .zshrc _pentadactylrc .pentadactyl )
